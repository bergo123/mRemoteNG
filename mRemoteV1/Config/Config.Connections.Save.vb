                ...
                With curConI
                    ...
                    With .Inherit
                        If Me._SaveSecurity.Inheritance = True Then
                            ...
                            _sqlQuery.CommandText &= "'" & .UseCredSsp & "',"
                            _sqlQuery.CommandText &= "'" & .UseRDPAdmin & "',"
                        Else
                            _sqlQuery.CommandText &= "'" & False & "',"
                            _sqlQuery.CommandText &= "'" & False & "',"
                            _sqlQuery.CommandText &= "'" & False & "',"
...
#Region "XML"
            ...
            Private Sub SaveConnectionFields(ByVal curConI As Connection.Info)
                Try
                    ...
                    _xmlTextWriter.WriteAttributeString("UseRDPAdmin", "", curConI.UseRDPAdmin)
                    ...
                    If Me._SaveSecurity.Inheritance = True Then
                        ...
                        _xmlTextWriter.WriteAttributeString("InheritUseRDPAdmin", "", curConI.Inherit.UseRDPAdmin)
                    ...
                    Else
                        ...
                        _xmlTextWriter.WriteAttributeString("InheritUseRDPAdmin", "", True)
